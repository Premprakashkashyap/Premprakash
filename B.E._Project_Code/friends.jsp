...
<div style="position:absolute; left:299px; top:270px"><img src="images/img09.GIF" width="2" height="480"></div>
...
<div style="position:absolute; left:360px; top:240px;"><font color="#FFFFFF" size="5"><font color="#FFFFCC"> 
      Find Friends</font></font></div>
		<div style="position:absolute; left:361px; top:310px; width: 358px; height: 316px;">
	...
	try
	{
		...
		while(rs2.next())
		{
				...
				{
					Class.forName("com.mysql.jdbc.Driver");	
					con3 = DriverManager.getConnection("jdbc:mysql://localhost:3306/socialnetwork","root","");;
					...
					rs3=st3.executeQuery(sql3);
						...
						if(rs3.next())
   						{%>
							...
							<font color="#FFFFCC" size="3"><strong><%=rs3.getString("status")%></strong></font></p>
      ...
      <p><img src="viewimage.jsp?id=<%=fid%>" alt="" width="120" height="99" /> 
        <a href="request.jsp?id=<%=rid%>"><font color="#FFFFCC" size="3"><strong>Send 

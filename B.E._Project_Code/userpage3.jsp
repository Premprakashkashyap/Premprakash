...
<div style="position:absolute; left:360px; top:240px;"><font color="#FFFFFF" size="5"><font color="#FFFFCC"> 
    ...
    <legend><font color="#FFFFFF"><strong><font size="4">Image</font></strong></font></legend>
  	...
  	View view = ViewDAO.getViewById(pid);
  ...
  %>
			...
			<tr></tr>
			<tr><td><font color="#FFFFFF" size="+1"><strong>Name : <%=session.getAttribute("user")%> Permission - <%=view.getStatususa() %> </strong></font></td></tr>
			<tr></tr>
			<tr></tr>
 ...
 //end friends view
  %>
			...
			<tr><td><font color="#FFFFFF" size="+1"><strong><%=countfds%># of Friends.Permission  -  <%=view.getStatususb() %></strong></font></td></tr>
			<tr></tr>
			<tr></tr>
			<tr><td><font color="#FFFFFF" size="+1"><strong><%=countfly%># of Family.Permission  - <%=view.getStatususc() %></strong></font></td></tr>
  		</table>
				</fieldset>
</div>

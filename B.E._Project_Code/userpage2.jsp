...
<div style="position:absolute; left:360px; top:341px; width: 398px; height: 140px;">
		<form name="f1" ENCTYPE="multipart/form-data" action="uploadpage2.jsp" method="post" onsubmit="return validation();">
		<fieldset>
      
    <legend><font color="#FFFFFF"><strong><font size="4">Select Settings</font></strong></font></legend>

...
<br><br>
    ...
    <legend><font color="#FFFFFF"><strong><font size="4">Your FriendList</font></strong></font></legend>
	...
	try
	{
		...
		<table align="center" height="185">
			<tr><td height="34"><strong>RelationShip:&nbsp;&nbsp;&nbsp;<%=relationship%></strong></td></tr>
				...
				<a href="holder2.jsp?id=<%=fid%>"><strong><font color="#FFFFCC"><%=rs3.getString("name")%></font></strong></a>
				</td></tr>
				<tr><td>

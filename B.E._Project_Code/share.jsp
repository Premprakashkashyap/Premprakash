	...
	<div id="leftbar" class="sidebar">
		<ul>
			<li>
				...
				<ul>
					<br><br>
          <li><a href="userpage.jsp"><font color="#FFFFFF" size="3">Upload Photo</font></a></li>
					
          <li><a href="friends.jsp"><font color="#FFFFFF" size="3">Find Friends</font></a></li>
					
          <li><a href="share.jsp"><font color="#FFFFFF" size="3">Share Photo</font></a></li>
...
<br><br>
 ...
 Connection con2=null;
    ...
    <legend><font color="#FFFFFF"><strong><font size="4">Upload Image Here</font></strong></font></legend>
